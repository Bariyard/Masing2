                                      ...
                                      PaStreamCallbackFlags statusFlags)
{
    ...
    if(!m_pModule.isEmpty())
    {
        //process each test module in the list
        foreach( AudioModule *pMod, m_pModule )
        {
...
void AudioDeviceBase::RegisterAudioModule(AudioModule *pModule)
{
    m_pModule.push_back(pModule);
}

void AudioDeviceBase::ResetAudioModule()
{
    if(!m_pModule.isEmpty())
    {
        foreach(AudioModule *pMod, m_pModule ){
